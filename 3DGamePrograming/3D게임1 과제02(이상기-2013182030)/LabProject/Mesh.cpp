	...
	CMesh(pd3dDevice, pd3dCommandList)
{
	...
	pVertices[0] = CDiffusedVertex(XMFLOAT3(-fx, +fy, -fz), 
		Vector4::Add(xmf4Color,	RANDOM_COLOR));
	pVertices[1] = CDiffusedVertex(XMFLOAT3(+fx, +fy, -fz), 
		Vector4::Add(xmf4Color,	RANDOM_COLOR));
	pVertices[2] = CDiffusedVertex(XMFLOAT3(+fx, +fy, +fz), 
		Vector4::Add(xmf4Color,	RANDOM_COLOR));
	pVertices[3] = CDiffusedVertex(XMFLOAT3(-fx, +fy, +fz), 
		Vector4::Add(xmf4Color,	RANDOM_COLOR));
	pVertices[4] = CDiffusedVertex(XMFLOAT3(-fx, -fy, -fz), 
		Vector4::Add(xmf4Color,	RANDOM_COLOR));
	pVertices[5] = CDiffusedVertex(XMFLOAT3(+fx, -fy, -fz), 
		Vector4::Add(xmf4Color,	RANDOM_COLOR));
	pVertices[6] = CDiffusedVertex(XMFLOAT3(+fx, -fy, +fz), 
		Vector4::Add(xmf4Color,	RANDOM_COLOR));
	pVertices[7] = CDiffusedVertex(XMFLOAT3(-fx, -fy, +fz), 
		Vector4::Add(xmf4Color,	RANDOM_COLOR));
	...
	XMFLOAT4 xmf4Color) : CMesh(pd3dDevice, pd3dCommandList)
{
	...
	pVertices[i++] = CDiffusedVertex(XMFLOAT3(0.0f, +(fy + y3), -fz),
		Vector4::Add(xmf4Color, RANDOM_COLOR));
	pVertices[i++] = CDiffusedVertex(XMFLOAT3(+x1, -y1, -fz), 
		Vector4::Add(xmf4Color, RANDOM_COLOR));
	pVertices[i++] = CDiffusedVertex(XMFLOAT3(0.0f, 0.0f, -fz), 
	...
	pVertices[i++] = CDiffusedVertex(XMFLOAT3(-x1, -y1, -fz), 
		Vector4::Add(xmf4Color, RANDOM_COLOR));
	pVertices[i++] = CDiffusedVertex(XMFLOAT3(+x2, +y2, -fz), 
		Vector4::Add(xmf4Color, RANDOM_COLOR));
	pVertices[i++] = CDiffusedVertex(XMFLOAT3(+fx, -y3, -fz), 
		Vector4::Add(xmf4Color, RANDOM_COLOR));
	pVertices[i++] = CDiffusedVertex(XMFLOAT3(+x1, -y1, -fz), 
		Vector4::Add(xmf4Color, RANDOM_COLOR));
	pVertices[i++] = CDiffusedVertex(XMFLOAT3(-x2, +y2, -fz), 
	...
	CMesh(pd3dDevice, pd3dCommandList)
{
	...
	pnIndices[9] = 7; pnIndices[10] = 6; pnIndices[11] = 4;
