...
public:
	...
	XMFLOAT3 GetMissilePos();

	void LaunchMissile() { m_pHellfileMissileFrame->m_bActive = true; m_bLaunch = true; }
	void ExplodeMissile() { m_pHellfileMissileFrame->m_bActive = false; m_bLaunch = false; }
...
public:
	CHeightMapImage* GetHeightMapImage() { return m_pHeightMapImage; }
